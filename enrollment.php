...
<body>
        ...
        <div class="container">
            <div class="title-area">
                <h2 class="sec-title">
                    ...
                    <span class="highlight">Freshmen</span> (Online)
                </h2>
            </div>
            <div class="row">
                <div class="col">
                ...
                <div class="col">
                    <div class="feature-block">
                        ...
                        <p class="feature-block_text">
                            ...
                            <span class="contact">09123505647 / 09678456152</span>
                        </p>
                    </div>
                </div>
                <div class="col">
         ...
         <!-- container for the freshmen walk in enrollment -->
    <div class="space">
        <div class="container">
            <div class="title-area">
                <h2 class="sec-title">
                    Enrollment Procedure for
                    <span class="highlight">Freshmen</span> (Walk-in)
                </h2>
            </div>
            <div class="row">
                <div class="col">
                ...
                <div class="col">
                    <div class="feature-block">
                        ...
                        <p class="feature-block_text">
                            <b class="highlight">Register online.</b> Visit
                            <a href="#" class="link">system.rmmc.edu.ph/rmmcweb/collegeenroll</a>
                            and encode your details. <br>
                            <b class="room">ROOM: EMM205</b>
                    </div>
                </div>
                <div class="col">
                    <div class="feature-block">
    ...
    <!-- Repeat the above structure for each section as needed -->
    ...
    <div class="space">
        <div class="container">
            <div class="title-area">
                <h2 class="sec-title">
                    Enrollment Procedure for
                    <span class="highlight">Transferees</span> (Online)
                </h2>
            </div>
            <div class="row">
                <div class="col">
    ...
    <!-- container for the Transferees walk in  -->
                ...
                <div class="col">
                    <div class="feature-block">
                        ...
                        <p class="feature-block_text">
                            ...
                            The student will be given the details to view for the
                            requirements. <br>
                            <b class="room">ROOM: COLLEGE DEPARTMENT</b>
                        </p>
                    </div>
                </div>
            </div>
