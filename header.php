...
<head>
    ...
    <link rel="stylesheet" href="styles/college_of_engineering.css"/>  <!-- FOR COLLEGE OF ENGINEERING CSS -->
        ...
        <div class="header_top">
            <div class="header_top_links">
                <ul class="header_top_links_collection">
                    <li><i class="fal fa-phone"><a href="tel:+256214203215"></a></i>+63 83 5523348</li>
                    <li><i class="fal fa-location-dot location" target="_block"><a
