...
<nav>
  <div class="header_top">
    <div class="header_top_links">
      <ul class="header_top_links_collection">
        <li><a href="tel:+256214203215" style="color:white; text-decoration:none;" class="icon_text">
        <i class="fa-solid fa-phone"></i> <span> +63 83 5523348</span> </a></li>
        <li><a class="icon_text"
            ...
            target="_block"><i class="fa-solid fa-location-dot"></i><span> Pioneer Ave.,
              GSC, South Cotabato, Philippines</span></a></li>
        <li>
          <a href="" class="icon_text"><i class="fa-solid fa-envelope"></i>
            <span> contact us@rmmc.edu.ph</span></a>
        </li>
      </ul>
    </div>
  ...
  <div class="menu_header">
    ...
    <div class="menu_header__left">
      <div class="menu_header__left__logo">
        <a href="index.php">
    ...
    <ul class="menu_header__right">
      <li class="menu_header__right__item">
        <a href="index.php">Home</a>
      </li>
      <li class="menu_header__right__item">Admission
      <i class="fa-solid fa-angle-down"></i>
        <ul class="menu_header__right__item__list">
          <li>
      ...
      <li class="menu_header__right__item">Academics
        <i class="fa-solid fa-angle-down"></i>
        <ul class="menu_header__right__item__list">
          <li>
            <div>
          ...
          <li class="menu_header__right__item__list__item">
            ...
            <ul class="menu_header__right__item__list__item__inner-list">
              ...
              <li>
                <a href="">
                  <i class="fa-solid fa-book"></i>
                  College of Business Educatiuon
                </a>
              </li>
              <li>
                <a href="">
      ...
      <li class="menu_header__right__item">
        ...
        <ul class="menu_header__right__item__list">
          ...
          <!-- <li><a href="gallery.php"><i class="fa-solid fa-book"></i> Gallery</a>
                    </li>  -->
        </ul>
      </li>
      <li class="menu_header__right__item">
        ...
        <ul class="menu_header__right__item__list">
          <li><a href="http://system.rmmc.edu.ph/rmmcweb/index.php"><i class="fa-solid fa-book"></i> Portal
              Login</a>
          </li>
          <li><a href="https://rmmc.instructure.com/login/canvas"><i class="fa-solid fa-book"></i> LMS
              Login</a>
          </li>
        </ul>
      </li>
      <li class="menu_header__right__item">
        ...
        <!-- <ul class="menu_header__right__item__list">
                    <li><a href="school1.php"><i class="fa-solid fa-book"></i> Research</a>
                    </li>
                    <li><a href="school2.php"><i class="fa-solid fa-book"></i> Student
                            Affairs</a>
                    </li>
                    <li><a href="school3.php"><i class="fa-solid fa-book"></i>
                            Internationalization</a>
                    </li>
                    <li><a href="school3.php"><i class="fa-solid fa-book"></i> Community
                            Extension</a>
                    </li>
                    <li><a href="school3.php"><i class="fa-solid fa-book"></i> Alumni
                            Affairs</a>
                    </li>
                    <li><a href="school3.php"><i class="fa-solid fa-book"></i> Library</a>
                    </li>
                </ul> -->
      </li>
      <li class="menu_header__right__item">
